...
def cli_main():
    ...
    if os.path.exists(neptune_path):
        ...
        neptune_logger = NeptuneLogger(
            api_key="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiJmMDRjNjUwMC0wYmJmLTQ5MjUtYmI1Mi0xNThhNWIwNmVlOTUifQ==", 
            project=args.neptune_proj)
