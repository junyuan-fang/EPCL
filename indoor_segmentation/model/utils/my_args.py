...
def my_args():
    ...
    # model
    # ------------
    parser.add_argument('--model', default='net_epcl')#, help='select model')
    # ------------
    # network hyper-parms
    # ------------
    parser.add_argument('--arch', default='epcl')
    ...
    parser.add_argument('--arkit_train_root', tyep = str, default="/home/fangj1/Code/Vision-Language-on-3D-Scene-Understanding/EPCL/indoor_segmentation/data/cvpr24-challenge/data/ChallengeTrainSet")
    parser.add_argument('--arkit_test_root', tyep = str, default="/home/fangj1/Code/Vision-Language-on-3D-Scene-Understanding/EPCL/indoor_segmentation/data/cvpr24-challenge/data/ChallengeTestSet")
    ...
    parser.add_argument('--MYCHECKPOINT', default='./checkpoint')#, help='save model')
    ...
    parser.add_argument('--neptune_proj', type=str, default="junyuan-fang/EPCL")
    parser.add_argument('--print_freq', type=int, default=1)
    parser.add_argument('--neptune_id', type=str, default="junyuan-fang")
    parser.add_argument('--neptune_key', type=str, default="eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiJmMDRjNjUwMC0wYmJmLTQ5MjUtYmI1Mi0xNThhNWIwNmVlOTUifQ")
